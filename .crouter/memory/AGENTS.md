...
surfaces:
  - on: boot
    at: content
last-updated: 2026-09-05T06:28:20.521Z
origin:
...
- Bundle runtime dependencies into `bin/capture` by default. One decided exception: Lighthouse ships as a normal npm dependency loaded at runtime, because it reads its audits, locales, and report assets package-relative and cannot be bundled — the binary is no longer fully standalone, and that tradeoff is accepted.
